...
def model1(split_num,predict_result):
    g2 = tf.Graph()
    ...
    CHINESE_MODEL_PATH = "opencv_ml/model1/cnn_chs/chs.ckpt"  # "model/cnn_chs/chs.ckpt"#"model/cnn_enu/enu.ckpt"
    #sess1 = tf.Session(graph=g2)
    with tf.Session(graph=g2) as sess:
        saver = tf.train.Saver()
        saver.restore(sess, CHINESE_MODEL_PATH)

        digit_image_path = "mypic0.jpg"  # "mypic0.jpg"#"images/digit.jpg"#/english.jpg"#
        ...
        predict_result.append(CHINESE_LABELS[predict])
        print(CHINESE_LABELS[predict])
        text = CHINESE_LABELS[predict]
    #sess.close()
    return text
